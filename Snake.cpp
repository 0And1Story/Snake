...
protected:
	//{{AFX_MSG(CAboutDlg)
	afx_msg void OnGamehelp();
	afx_msg void OnGamehelpM();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_GAMEHELP, OnGamehelp)
	ON_COMMAND(IDM_GAMEHELP, OnGamehelpM)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CAboutDlg::OnGamehelp() 
{
	// TODO: Add your control notification handler code here
	AfxMessageBox(("\
玩法指导:\n\
\n\
通过\"上\"\"下\"\"左\"\"右\"来控制蛇的行进，蛇头碰到小方块即视为吃到了食物，每吃到一个加10分!!!\n\
菜单栏上的\"S\"\"P\"\"C\"\"E\"分别为 游戏开始,游戏暂停,游戏继续,游戏退出"),MB_ICONQUESTION);
}

void CAboutDlg::OnGamehelpM() 
{
	// TODO: Add your command handler code here
	CAboutDlg::OnGamehelp;
}
